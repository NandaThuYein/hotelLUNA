...
<head>
	...
	<title>Booking Update Page</title>
...
<div class="container"> 
            <div class="main_contents">     
                ...
                <form:form action="/hotelLUNA/updatebook" method="POST" modelAttribute="book">
