...
<div class="container"> 
            <div class="main_contents">     
                <div class="contents"> 
                <h3 style="color:brown;">Booking List</h3>
                
               <form:form action="/hotelLUNA/searchbcustomer" method="POST" modelAttribute="book">
                	<table class="tableForm">
                		<tr>
							<td class="bookId"><label>Booking ID</label></td>
							<td class="idInput">
							<form:input path="rb.rbid"/>
							</td>
						
							<td class="customerId">Booking Customer Name</td>
							<td class="nameInput">
                 ...
                 <div class="roomscroll">
                	<form name="listForm">
						...
						<tr>
							...
							<td>
							<a href="/hotelLUNA/deletebook/${b.cid}/${b.rb.rbdid}">
                             	<input type="button" value="Delete" id="delete" class="button" onClick="javascript:checkDelete()" />
                            </a>
                            </td>
							<td>
								<a href="/hotelLUNA/updatebook/${b.cid}/${b.rb.rbdid}">
                            		<input type="button" value="Update" class="button" id="userUpdate" />
                        		</a>
                        	</td>
                        	<td>
                        		<a href="/hotelLUNA/approve/${b.cid}/${b.rb.rbdid}/${b.rb.rbid}">
                        			<input type="button" value="approve" id="active" class="button" />
                        		</a>
                        	</td>
						</tr>
					</c:forEach>
