...
<head>
		...
		function update()
    {
        ...
        {
            window.close();
            window.location.replace('searchroom.html')
        }
...
<div class="header">
	...
	<div class="sidebar">
		...
		<ul class="nav-links">
			<li>
			<a href="adminpage.html" class="active"><span class="links_name">Admin Dashboard</span></a>
			</li>
...
<div class="container"> 
            <div class="main_contents">     
                <div class="contents"> 
                <h3 style="color:brown;">Add Room</h3>
                <div id="errormsg">
					<label id="message">Message</label>
				</div>
            
                <form:form class="ta" action="/hotelLUNA/insetroom" method="POST" modelAttribute="room">
                
                	<table class="addroom">
                	<tr>
                		<td class="label">Room ID</td>
                		<td class="room_id"><form:input path="rid"/></td>
                	</tr>
                	<br/>
                	<tr>
                		<td class="label">Capacity</td>
                		<td class="room_capacity"><form:input path="rcapacity"/></td>
                	</tr>
                	<br/>
                	<tr>
                		<td class="label">Price</td>
                		<td class="room_price"><form:input path="rprice"/></td>
                	</tr>
                	<br/>
                	<tr>
                ...
                <br/>
                	<tr>
                		<td class="submit"><input type="submit" onClick="javascript:update()" value="Add" /></td>
                	</tr>
               </form:form>
                </div>
